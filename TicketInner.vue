            ...
            <div class="Ordertest1">
                <div class="Ticket_pic">
                    ...
                    <div class="Ticket_pic_txt">
                        <h4 class="Title_2"
                            v-for="(feature, index) in [tickets.t_feature1, tickets.t_feature2, tickets.t_feature3]"
                            :key="index"><font-awesome-icon :icon="['fas', 'paw']" style="color: #FFD43B;" /> {{ feature
                            }}</h4>
                    </div>
                </div>
                <div class="Ticket_txt Title">
                    <h4 class="Title_2 Title_color">景點介紹</h4>
                    <h5 class="Title_2"><font-awesome-icon :icon="['fas', 'paw']" style="color: #FFD43B;" /> {{
                        tickets.t_spot }}</h5>
                    <p v-html="tickets.t_content"></p>
                </div>
                <div class="Purchase Title">
                    <h4 class="Title_2 Title_color">票券說明</h4>
                    <h5 class="Title_2"><font-awesome-icon :icon="['fas', 'paw']" style="color: #FFD43B;" /> 未滿 6
                        歲的孩童可免費入場，敬請知悉。</h5>
                    <h5 class="Title_2"><font-awesome-icon :icon="['fas', 'paw']" style="color: #FFD43B;" />
                        【有關訂購後未使用票券之取消】<br>恕無法進行訂單中的票券取消作業敬請知悉。</h5>
                </div>
                <div class="Use Title">
                    <h4 class="Title_2 Title_color">使用說明</h4>
                    <h5 class="Title_2"><font-awesome-icon :icon="['fas', 'paw']" style="color: #FFD43B;" />
                        請直接至入口處出示附有「QR CODE」的電子憑證。</h5>
                    <h5 class="Title_2"><font-awesome-icon :icon="['fas', 'paw']" style="color: #FFD43B;" /> 第一次使用後 1
                        天之內有效，逾期無效</h5>
                </div>
            </div>
